---
title: "Cum citești factura la energie ca prosumator: compensare, tarife, TVA"
categorie: reglementari-preturi
data: 2026-07-30
sursaNume: "—"
sursaUrl: "Conținut propriu — fără sursă externă unică"
imagine: "/images/articole/cum-citesti-factura-la-energie-ca-prosumator-compensare-tarife-tva.webp"
---

Factura de energie electrică a unui prosumator arată vizibil diferit față de cea a unui consumator obișnuit, pentru că trebuie să reflecte atât energia consumată din rețea, cât și energia produsă și livrată înapoi în rețea de sistemul fotovoltaic propriu. Pentru cine a instalat recent panouri, prima factură primită după activarea statutului de prosumator poate fi derutantă — iată la ce să te uiți concret.
...
Al doilea reper e structura tarifului. Pe lângă prețul energiei active efectiv consumate, factura conține componente reglementate separate: tariful de distribuție (plătit către operatorul de rețea local), tariful de transport — cunoscut ca tariful BINOM, deja explicat pe larg pe Electric NEWS — și contribuția pentru certificate verzi, o taxă mică dar constantă, recalculată anual de ANRE. Aceste componente se aplică de regulă la energia consumată din rețea, nu la cea produsă și compensată, dar modul exact de calcul poate varia ușor între furnizori — motiv pentru care merită citită explicit secțiunea de detaliere a facturii, nu doar totalul final.
...
Un ultim reper util e perioada de facturare și modul de citire a contorului inteligent (dacă instalația are unul): compensarea se calculează, de regulă, pe intervalul de facturare curent, nu instantaneu — ceea ce înseamnă că o zi cu producție foarte mare, dar consum mic, nu se „vede" izolat pe factură, ci se topește în totalul lunii sau al intervalului bifacturat.
